...
class QuickConnectDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is QuickConnectDto && other.secret == secret;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "QuickConnectDto[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "QuickConnectDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<QuickConnectDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<QuickConnectDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = QuickConnectDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
